...
import { Button, Input, Form, Row, Col, Rate, Loading, Dialog, Tabs, TabPane, Pagination, Table, tableColumn, Checkbox, Menu, MenuItem, FormItem, Upload, Popover } from 'element-ui'
Vue.use(Button)
Vue.use(Input)
Vue.use(Checkbox)
Vue.use(Form)
